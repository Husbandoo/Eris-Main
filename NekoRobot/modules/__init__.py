...
LOGGER.info("Shikimori is starting. | Projected By Light. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/shiinobu (t.me/Light-Sensei)")
...
try:
    ...
    raise Exception(
        "[ERIS ERROR]: Your NAMI • Data Center • Mumbai • Redis Database Is Not Alive, Please Check Again."
    )
