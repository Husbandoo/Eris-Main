...
def protecc(update, context):
    ...
    if json:
        ...
        if char_name in WAIFUS:
            ...
            update.effective_message.reply_text(f"OwO you protecc'd {char_name}. This character has been added to your harem.")
...
def fvrt_waifu(update, context):
    ...
    if fvrt_char: 
        ...
        message.reply_text("You havent guessed anyone yet!")
